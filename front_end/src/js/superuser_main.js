...
document.addEventListener('DOMContentLoaded', () => {
  ...
  loadAppShell().then(() => {
    ...
    /* ────────────────────────────────────────────────────────
       ...
       ──────────────────────────────────────────────────────── */
    document.getElementById('save-role-perms-btn').addEventListener('click', saveRolePermissions);
    ...
    const validPages = ['dashboard', 'participants', 'roles', 'configuration', 'complaints', 'notifications', 'profile'];

...
function renderDashboard() {
  ...
  const roleLine = escHtml(
    `${profile.role || "Administrator"} · ${profile.email || "admin.primary@propsync.com"}`,
  );

  const statsCards = [
    {
      title: "Total System Participants",
      value: "1,248",
      change: "+12.5%",
      trend: "up",
      iconType: "users",
  ...
  container.innerHTML = `
    <div style="margin-bottom:24px;">
      ...
      <p style="font-size:14px;color:#6b7280;">${roleLine} · Monitor system-wide statistics and activity</p>
    </div>

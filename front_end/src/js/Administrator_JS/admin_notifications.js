...
function notifTypeColors(type) {
  switch (type) {
    case "success":
      return { bg: "#dcfce7", text: "#16a34a", borderClass: "unread-success" };
    case "warning":
      return { bg: "#ffedd5", text: "#ea580c", borderClass: "unread-warning" };
    case "error":
      return { bg: "#fee2e2", text: "#dc2626", borderClass: "unread-error" };
    default:
      return { bg: "#dbeafe", text: "#2563eb", borderClass: "unread-info" };
  }
}
...
function renderNotifications(skipBackendRefresh = false) {
  if (
    !skipBackendRefresh &&
    typeof refreshBackendNotifications === "function"
  ) {
